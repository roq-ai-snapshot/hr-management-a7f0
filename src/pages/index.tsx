  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower your workforce with HR Management - a comprehensive solution for managing employee data, tracking time, planning vacations, processing payrolls, and conducting performance evaluations. All in one central place."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your workforce with HR Management - a comprehensive solution for managing employee data, tracking time, planning vacations, processing payrolls, and conducting performance evaluations. All in one central place.`}
            </Text>
            <Box
